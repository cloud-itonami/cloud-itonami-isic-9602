# Operator Quickstart — Hairdressing and other beauty treatment

Shortest path from clone to a verified local dry-run for **ISIC 9602** (`cloud-itonami-isic-9602`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9602.git
cd cloud-itonami-isic-9602
```
...
- Blueprint governor key: `personal-service-safety-governor`
- Likely source path: `salon.governor.cljc`
